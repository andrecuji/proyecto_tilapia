...
@Component({
  selector: 'app-grafico-temperatura',
  standalone: true,
  imports: [HttpClientModule, ToastModule],
  templateUrl: './grafico-temperatura.component.html',
  styleUrl: './grafico-temperatura.component.css',
  providers: [MessageService, SensorService] 
})
export class GraficoTemperaturaComponent implements OnInit, OnDestroy {
